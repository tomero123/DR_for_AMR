...
from OLD.xgboost_cv import get_final_df, get_kmers_df, \
    get_current_results_folder, get_label_df, convert_results_df_to_new_format, \
    get_agg_results_df, get_all_resulst_df, xgboost_cv
...
if __name__ == '__main__':
    ...
    for antibiotic in antibiotic_list:
        now = time.time()
        print(f"{datetime.datetime.now().strftime(TIME_STR)} STARTED CALCULATING get_final_df for bacteria: {BACTERIA}, antibiotic: {antibiotic}")
        ...
        xgboost_cv(final_df, amr_df, results_file_path, model_params, random_seed, antibiotic, kmers_original_count, kmers_final_count, FEATURES_SELECTION_N, all_results_dic, USE_MULTIPROCESS)
